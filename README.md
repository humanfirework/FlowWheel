...
- **↔️ Omni-directional**: Supports not just vertical, but also horizontal scrolling (if the app supports it), making it perfect for wide tables or canvases.
...
- **↔️ 全向滚动**：不仅支持垂直滚动，还完美支持水平滚动（需应用本身支持），宽表格/画板浏览更轻松。
