...
namespace FlowWheel.Core
{
    ...
    public class AppConfig
    {
        ...
        public string ToggleHotkey { get; set; } = "Ctrl+Alt+S"; // Custom Hotkey
        public string ReadingModeHotkey { get; set; } = "Ctrl+Alt+R"; // Reading Mode Hotkey
        public int MiddleClickDelay { get; set; } = 150; // Middle click delay in ms to prevent accidental triggers
        ...
        public bool BreakSpeedLimit { get; set; } = false; // 突破速度限制
        public double BreakSpeedLimitMax { get; set; } = 2000.0; // 突破速度限制时的最大值
